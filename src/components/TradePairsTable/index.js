        ...
        render: (text, record) => {
          if (record.editable) {
            return (
              <Input
                value={text}
                onChange={e => this.handleFieldChange(e, 'remarks', record.key)}
                onKeyPress={e => this.handleKeyPress(e, record.key)}
                placeholder="备注"
              />
            );
    ...
    return (
      <Fragment>
        <div className={styles.title}>
          {title}
          <Button onClick={this.newMember} type="primary" className={styles.floatright}>
            添加
          </Button>
        </div>
        <Table
...
export default TradePairsTable;
